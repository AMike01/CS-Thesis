...
\usepackage{fancyhdr}
\usepackage{float}                      % gestione piazzamento delle figure
\usepackage{colortbl}
\usepackage[table,xcdraw]{xcolor}              % Per colori nelle tabelle
\usepackage{array}                      % Per allineamenti personalizzati