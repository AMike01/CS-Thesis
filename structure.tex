...
\begin{document}
    ...
    \mainmatter
    \input{chapters/contesto-aziendale.tex}
    \input{chapters/introduzione-al-progetto.tex}
    \input{chapters/svolgimento-dello-stage.tex}
    \input{chapters/retrospettiva-finale.tex}
