...
Sono andato ad implementare il \gls{backend} tramite l'utilizzo di diversi \textit{endpoints}, che permettono la gestione delle richieste dal \gls{frontend}.\\
Di seguito approfondisco gli \textit{endpoints} che implementano le funzionalità più avanzate, offrendo interazioni significative tra il \gls{frontend}, il \gls{backend} e i servizi esterni.
