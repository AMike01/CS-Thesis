...
\noindent Nel \gls{frontend} dell'applicazione ho sviluppato 8 componenti \textit{React}, 3 \textit{custom hooks} e 5 pagine. \\
Di seguito, presento una descrizione delle pagine più significative, illustrandone le funzionalità principali e le modalità di interazione con il \gls{backend}.
